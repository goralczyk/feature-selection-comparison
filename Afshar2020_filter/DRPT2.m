function selected_features = DRPT2(data, n_genes)
...
runIter = 5; %number of independent runs
t = 50;
...
for n=2
   ...
   %====================Sorting PX and Finding top ranked features====================
       ...
       %===========================Classifiying============================
        ...
        for k=2:upperBand
            centres = out(1:k);
            writematrix(centres', 'debug-centers.csv');
            writematrix(c , 'debug-c.csv');
   ...
   selected_features = nonzeros(featuresPicked(:,best_acc))'
end
